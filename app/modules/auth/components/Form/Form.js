...
/**
 * This file creates a Form component that accepts an array of fields 
 * and creates the TextInput for each field, 
 * renders a button and also in charge of validating the data 
 * and extracting the data to be passed to the API.
 * 
 * The important things to focus on in this file is 
 * the way the state variable is been created in the constructor function 
 * and the extracting of the field value in the extractData function
*/
